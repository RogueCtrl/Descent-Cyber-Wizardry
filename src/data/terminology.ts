...
export const TERMINOLOGY = {
    classic: {
        ...
        combat_help_attack: 'Roll to hit, then roll damage if successful. Some attacks may have special effects.',
        combat_help_spell: 'Cast a memorized spell. Success depends on caster level vs spell difficulty.',
        combat_help_defend: 'Gain +2 AC bonus until your next turn.',
        combat_help_item: 'Use a consumable item from your inventory.',
        combat_help_formation_front: 'Front row characters take more damage but attack more effectively.',
        ...
        // Dungeon Messages
        training_grounds_boss_message: 'A massive ogre blocks your path, wielding a fearsome greatclub!',
    ...
    cyber: {
        ...
        // Combat Help
        combat_help_overview: 'Engagement is cycle-based. Each agent executes protocols in latency order.',
        combat_help_attack: 'Execute offensive algorithms. Damage depends on program integrity and firewall penetration.',
        combat_help_spell: 'Run a loaded subroutine. Success depends on processing power vs encryption level.',
        combat_help_defend: 'Boost firewall rating (+2 DR) until next cycle.',
        combat_help_item: 'Deploy a data package or system patch.',
        combat_help_formation_front: 'Forward node agents have high bandwidth but are exposed to direct attacks.',
        combat_help_formation_back: 'Support node agents are behind firewalls but have limited direct connection.',
        ...
        // Dungeon Messages
        training_grounds_boss_message: 'A massive Guardian Program blocks your path, wielding a fearsome banhammer!',
...
// Backwards compat: keep window globals during migration
