...
export const TERMINOLOGY = {
  classic: {
    ...
    town: 'Town',
    town_description:
      "The bustling hub of Llylgamyn, where adventurers prepare for their descent into the Mad Overlord's maze.",
    ...
    race_selection_description:
      "Each race has unique characteristics that will affect your character's abilities.",
    ...
    escaped_safe_return:
      'These heroes have returned to Town safely, though they are confused from their hasty retreat.',
    ...
    delete_party_warning:
      'Parties currently in the dungeon will be lost forever. This action cannot be undone.',
    ...
    delete_character_warning:
      "This hero's memory will be lost forever. This action cannot be undone.",
    delete_character_button: 'Forget Hero',
    forget_character_detail:
      'Forgetting {name} ({race} {class}) will remove all records permanently.',
    character_last_location: 'Last seen in {location}',

    // Character Details Modal
    /* duplicate: character_details */ _dup_character_details: 'Character Details',
    /* duplicate: attributes */ _dup_attributes: 'Attributes',
    ...
    // Combat Help
    combat_help_overview: 'Combat is turn-based. Each character acts in initiative order.',
    combat_help_attack:
    ...
    combat_help_defend: 'Gain +2 AC bonus until your next turn.',
    combat_help_item: 'Use a consumable item from your inventory.',
    combat_help_formation_front:
      'Front row characters take more damage but attack more effectively.',
    combat_help_formation_back: 'Back row characters are protected but have limited melee options.',

    // Combat Action Names
    action_attack_name: 'Attack',
    action_attack_desc: 'Make a melee or ranged attack',
    action_spell_name: 'Cast Spell',
    action_spell_desc: 'Cast a memorized spell',
    action_defend_name: 'Defend',
    action_defend_desc: 'Take defensive stance (+2 AC until next turn)',
    action_item_name: 'Use Item',
    action_item_desc: 'Use an item from inventory',

    // Dungeon Messages
    training_grounds_boss_message:
      'A massive ogre blocks your path, wielding a fearsome greatclub!',
    special_healing_fountain: 'A crystal clear fountain bubbles with restorative waters.',
    special_stamina_fountain: 'This fountain glows with energizing light.',
    special_poison_fountain: 'The water here has a sickly green tint.',
    special_teleporter: 'Strange runes circle this magical portal.',
    special_message_square: 'Ancient text is carved into the floor here.',
    special_treasure_chest: 'A sturdy chest sits here, lock gleaming.',
    special_unknown: 'Something unusual is here.',
  },
  ...
  cyber: {
    ...
    town: 'Terminal Hub',
    town_description:
      'The central access node of the grid, where Agents prepare for their infiltration into the hostile data maze.',
    ...
    race_selection_description:
      "Each platform type has unique parameters that will affect your agent's core systems.",
    ...
    class_selection_description:
      'Your configurations determine which specializations are available to you.',
    ...
    escaped_safe_return:
      'These agents have returned to Terminal Hub safely, though they are scrambled from their hasty disconnection.',
    ...
    delete_party_warning:
      'Strike teams currently in the corrupted network will be lost forever. This action cannot be undone.',
    ...
    delete_character_warning:
      "This agent's data will be permanently deleted. This action cannot be undone.",
    ...
    // Character Details Modal
    /* duplicate: character_details */ _dup_character_details: 'Agent Profile',
    /* duplicate: attributes */ _dup_attributes: 'Parameters',
    ...
    combat_help_overview:
      'Engagement is cycle-based. Each agent executes protocols in latency order.',
    combat_help_attack:
      'Execute offensive algorithms. Damage depends on program integrity and firewall penetration.',
    combat_help_spell:
      'Run a loaded subroutine. Success depends on processing power vs encryption level.',
    combat_help_defend: 'Boost firewall rating (+2 DR) until next cycle.',
    combat_help_item: 'Deploy a data package or system patch.',
    combat_help_formation_front:
      'Forward node agents have high bandwidth but are exposed to direct attacks.',
    combat_help_formation_back:
      'Support node agents are behind firewalls but have limited direct connection.',

    // Combat Action Names
    action_attack_name: 'Execute',
    action_attack_desc: 'Execute offensive protocols',
    action_spell_name: 'Run Program',
    action_spell_desc: 'Execute loaded subroutine',
    action_defend_name: 'Firewall',
    action_defend_desc: 'Boost firewall (+2 Defense Rating)',
    action_item_name: 'Use Data',
    action_item_desc: 'Deploy data package from memory',

    // Dungeon Messages
    training_grounds_boss_message:
      'A massive Guardian Program blocks your path, wielding a fearsome banhammer!',
    special_healing_fountain: 'A data repair node hums with restorative code.',
    special_stamina_fountain: 'This node glows with overclocking potential.',
    special_poison_fountain: 'The data stream here is corrupted with malware.',
    special_teleporter: 'Unknown protocols circle this network gate.',
    special_message_square: 'Legacy code is inscribed in the sector header.',
    special_treasure_chest: 'An encrypted data cache sits here, firewall active.',
    special_unknown: 'An anomalous signal is detected here.',
  },
};
