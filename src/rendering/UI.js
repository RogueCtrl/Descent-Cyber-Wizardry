...
class UI {
     ...
     */
    showTown() {
        // Create town interface in the game panel viewport
        const viewport = document.getElementById('viewport');
        if (viewport) {
            viewport.innerHTML = `
                <div class="town-interface">
                    <h2>Town of Llylgamyn</h2>
                    <p>Welcome to the town near the Mad Overlord's castle.</p>
                    <div class="town-locations">
                        <button id="training-grounds-btn" class="location-btn">Training Grounds</button>
                        <button id="enter-dungeon-btn" class="location-btn" ${this.party && this.party.size > 0 ? '' : 'disabled'}>Enter Dungeon</button>
                        <button id="tavern-btn" class="location-btn" disabled>Tavern (Coming Soon)</button>
                        <button id="shop-btn" class="location-btn" disabled>Equipment Shop (Coming Soon)</button>
                        <button id="temple-btn" class="location-btn" disabled>Temple (Coming Soon)</button>
                    </div>
                </div>
            `;
            ...
            const dungeonBtn = viewport.querySelector('#enter-dungeon-btn');
